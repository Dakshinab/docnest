...
<head>
    <meta charset="UTF-8">
    <title>HR Management | Docnest</title>
...
<section class="heading" style="background:url(../images/user.PNG) no-repeat">
    <h1>HR Management</h1>
</section>
...
<section class="service-detail">
    <div class="service-container">
        ...
        <p>Transform your HR operations with comprehensive solutions that optimize workforce management, enhance employee engagement, and drive organizational success.</p>
        
        <h3>Key Features:</h3>
        <ul>
            <li>Employee lifecycle management</li>
            <li>Performance management systems</li>
            <li>Compensation and benefits planning</li>
        ...
        <ul>
            ...
            <li>Strong organizational culture</li>
        </ul>
