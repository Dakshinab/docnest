...
<head>
    <meta charset="UTF-8">
    <title>CIDA Fast Track | Docnest</title>
...
<section class="heading" style="background:url(../images/blocks.PNG) no-repeat">
    <h1>CIDA Fast Track</h1>
</section>

<section class="service-detail">
    <div class="service-container">
        <h2>CIDA Fast Track Program</h2>
        <p>Accelerate your professional development with our CIDA Fast Track program, designed to enhance skills and certifications for construction professionals and project managers.</p>
        
        <h3>Key Features:</h3>
        <ul>
            <li>Accelerated training curriculum</li>
        ...
        <h3>Benefits:</h3>
        <ul>
            <li>Complete certification in 6-12 months</li>
