...
<head>
    <meta charset="UTF-8">
    <title>Compliance & Audit | Docnest</title>
...
<section class="heading" style="background:url(../images/whyus.png) no-repeat">
    <h1>Compliance & Audit</h1>
</section>

<section class="service-detail">
    <div class="service-container">
        <h2>Compliance & Audit Services</h2>
        <p>Ensure your organization maintains the highest standards of compliance and internal controls through comprehensive audit and advisory services.</p>
