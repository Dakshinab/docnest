...
<head>
    <meta charset="UTF-8">
    <title>Financial Planning | Docnest</title>
...
<section class="heading" style="background:url(../images/onenest.JPG) no-repeat">
...
<section class="service-detail">
    <div class="service-container">
        ...
        <p>Build a solid financial foundation with comprehensive planning and advisory services designed to grow your wealth and secure your future.</p>
        ...
        <ul>
            ...
            <li>Retirement and succession planning</li>
        ...
        <ul>
            ...
            <li>Maximized investment returns</li>
