...
<head>
    <meta charset="UTF-8">
    <title>Employee Training | Docnest</title>
...
<section class="service-detail">
    <div class="service-container">
        ...
        <p>Invest in your workforce with customized training programs that enhance skills, boost productivity, and foster professional growth.</p>
        ...
        <h3>Benefits:</h3>
        <ul>
            <li>Enhanced employee competencies</li>
            <li>Increased productivity</li>
            <li>Improved retention rates</li>
            <li>Strong internal succession pipeline</li>
        </ul>
