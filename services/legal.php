...
<head>
    <meta charset="UTF-8">
    <title>Legal Advisory | Docnest</title>
...
<section class="heading" style="background:url(../images/job.JPG) no-repeat">
    <h1>Legal Advisory</h1>
</section>

<section class="service-detail">
    <div class="service-container">
        <h2>Legal Advisory Services</h2>
        <p>Get expert legal counsel to protect your business interests and ensure full regulatory compliance across all operations.</p>
