...
<head>
    <meta charset="UTF-8">
    <title>Tourism Consulting | Docnest</title>
...
<section class="heading" style="background:url(../images/safari.JPEG) no-repeat">
    <h1>Tourism Consulting</h1>
</section>

<section class="service-detail">
    <div class="service-container">
        <h2>Tourism Consulting Services</h2>
        <p>Develop sustainable tourism strategies that attract visitors, enhance experiences, and generate revenue for your destination or business.</p>
        
        <h3>Key Features:</h3>
        <ul>
            <li>Destination marketing strategies</li>
            <li>Product development and packaging</li>
            <li>Tourism infrastructure planning</li>
            <li>Market research and analysis</li>
            <li>Sustainability and impact assessment</li>
        </ul>

        <h3>Benefits:</h3>
        <ul>
            <li>Increased visitor arrivals</li>
