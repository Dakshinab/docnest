...
<head>
    <meta charset="UTF-8">
    <title>Marketing Strategy | Docnest</title>
...
<section class="heading" style="background:url(../images/unlimited.JPG) no-repeat">
    <h1>Marketing Strategy</h1>
</section>

<section class="service-detail">
    <div class="service-container">
        <h2>Marketing Strategy Services</h2>
        <p>Drive brand awareness and customer engagement with data-driven marketing strategies tailored to your business goals.</p>
        
        <h3>Key Features:</h3>
        <ul>
            <li>Market research and analysis</li>
            <li>Brand positioning and messaging</li>
            <li>Digital and traditional marketing</li>
