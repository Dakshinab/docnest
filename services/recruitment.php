...
<head>
    <meta charset="UTF-8">
    <title>Recruitment & Onboarding | Docnest</title>
...
<section class="heading" style="background:url(../images/work.PNG) no-repeat">
    <h1>Recruitment & Onboarding</h1>
</section>

<section class="service-detail">
    <div class="service-container">
        <h2>Recruitment & Onboarding Solutions</h2>
        <p>Find the right talent and seamlessly integrate them into your organization. Our comprehensive recruitment and onboarding services ensure you attract, select, and retain top performers.</p>
        
        <h3>Key Features:</h3>
        <ul>
            <li>Executive and technical recruitment</li>
            <li>Candidate screening and assessment</li>
            <li>Structured onboarding programs</li>
            <li>Employee orientation and training</li>
        ...
        <ul>
            ...
            <li>Enhance employee retention</li>
