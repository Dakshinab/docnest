...
<head>
    <meta charset="UTF-8">
    <title>Smart Payroll Management | Docnest</title>
    ...
    <nav class="navbar">
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-content">
                <a href="payroll.php">Smart Payroll Management</a>
                <a href="recruitment.php">Recruitment & Onboarding</a>
                <a href="cida.php">CIDA Fast Track</a>
                <a href="building.php">Building Projects</a>
                <a href="hr.php">HR Management</a>
                <a href="it.php">Information Technology</a>
                <a href="tourism.php">Tourism Consulting</a>
                <a href="legal.php">Legal Advisory</a>
                <a href="marketing.php">Marketing Strategy</a>
                <a href="finance.php">Financial Planning</a>
                <a href="training.php">Employee Training</a>
                <a href="audit.php">Compliance & Audit</a>
            </div>
        </div>
...
<section class="heading" style="background:url(../images/money.PNG) no-repeat">
    <h1>Smart Payroll Management</h1>
</section>

<section class="service-detail">
    <div class="service-container">
        <h2>Smart Payroll Management</h2>
        <p>Simplify your payroll process with our intelligent payroll management solution. We handle salary calculations, tax deductions, compliance reporting, and fund transfers efficiently.</p>
        
        <h3>Key Features:</h3>
        <ul>
            <li>Automated salary calculations and disbursement</li>
            <li>Tax and statutory compliance management</li>
            <li>Real-time payroll reports and analytics</li>
